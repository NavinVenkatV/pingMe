        ...
        <div className="flex gap-2">
          ...
          <div className="hidden md:block">
            <Link href="https://github.com/NavinVenkatV/pingMe"
              className="px-2 py-1 bg-blue-500 hover:bg-blue-900 hover:scale-110 rounded-xl text-white transition duration-300 relative z-10 flex justify-center items-center"
            >
              GitHub
            </Link>
          </div>

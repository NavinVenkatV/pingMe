...
export default function Header({ setIsSideOpen }: typess) {
  ...
  return (
    <div className="w-full px-5 md:px-10 py-3 flex justify-between items-center rounded-xl bg-black/20 backdrop-blur-lg">
      ...
      <div className="flex gap-2">
        ...
        <Link href="https://github.com/NavinVenkatV/pingMe"
          className="px-2 py-1 bg-black hover:bg-blue-950  rounded-xl text-white transition-all  duration-300 relative z-10 flex justify-center items-center"
        >
          GitHub
        </Link>
        </div>
